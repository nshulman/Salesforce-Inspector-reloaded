...
import {setupLinks, sections} from "./links.js";
/* global initButton */
...
class Section extends React.Component {
  render() {
    return (
      h("p", {},
        setupLinks
          .filter(l => l.section == this.props.s)
          .map(l =>
            h("p", {marginLeft: "30px", style: {fontSize: "1.3em"}},
              h("a", {key: l.label, href: l.link, target: "_blank", marginLeft: "30px"}, l.label),
              h("span", {paddingLeft: "10px"}, l.alias || ""),
              h("span", {paddingLeft: "10px"}, l.link || ""),
            )
          )
      )
    );
